...
function migrate(db: Db): void {
  ...
  */
  ...
  /*
    ...
    2026-09-13 with the setting it stored.

    Dropped rather than left in place, on the `bio` reasoning above: what was
    in it is a coin toss and, for the handful of accounts that answered it, a
  ...
  */
  if (accountColumns.some((c) => c.name === 'tabs_at_foot')) {
    db.exec('ALTER TABLE accounts DROP COLUMN tabs_at_foot');
  }
