# Decisions, 2026-08-07 to 2026-08-13
...
2026-08-15, when the single file passed 2,400 lines and a plain read of it
stopped at 2,000 and silently dropped the tail.

It runs from the first decisions recorded, on 2026-08-07, to the day the media
server moved off LiveKit Cloud onto the box that was already there. That is the
seam: everything here predates self-hosted media, and a good deal of it assumes
LiveKit Cloud in ways the prose does not always stop to say.
